  ...
  return (
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat'>
      ...
      <div className='text-center mb-6'>
        <h1 className='text-3xl sm:text-5xl md:6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'>Create amazing content <br></br> with <span className=' text-primary'> AI tools</span></h1>
